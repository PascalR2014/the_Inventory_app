...
public class FishCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView nameTextView = (TextView) view.findViewById(R.id.text_name_item);
        TextView quantityTextView = (TextView) view.findViewById(R.id.remain_number);
        ...
        int imageIndex = cursor.getColumnIndex(FeedEntry.COLUMN_ITEM_IMAGE);
        int nameColumnIndex = cursor.getColumnIndex(FeedEntry.COLUMN_ITEM_NAME);
        int quantityIndex = cursor.getColumnIndex(FeedEntry.COLUMN_ITEM_QUANTITY);
        int priceIndex = cursor.getColumnIndex(FeedEntry.COLUMN_ITEM_PRICE);
        ...
        final long id = cursor.getLong(cursor.getColumnIndex(FeedEntry._ID));
        ...
        saleView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fishQuantity > 0 ) {
                    ...
                    Toast.makeText(activity, "Quantity unavailable, order more!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
